...
export const apiClient = {
  ...
  createCategory: (category: { name: string; marketRate: number; unit: string }) =>
    apiFetch('/categories', {
      method: 'POST',
  ...
  createUnit: (unit: { name: string; symbol: string }) =>
    apiFetch('/units', {
      method: 'POST',
  ...
  // Scrap Entries
  getScrapEntries: () => apiFetch('/scrap-entries'),
