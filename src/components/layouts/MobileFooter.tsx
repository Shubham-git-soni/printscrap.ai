...
export function MobileFooter({ onMenuClick }: MobileFooterProps) {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-card border-t shadow-lg safe-area-pb">
      <nav className="flex items-center justify-around px-1 py-2">
        ...
        <button
          onClick={onMenuClick}
          className="flex flex-col items-center justify-center gap-1 py-2 px-2 rounded-lg transition-colors text-muted-foreground hover:bg-muted flex-1 max-w-[80px]"
        >
